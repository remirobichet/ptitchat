...
<template>
  <section class="grid gap-4">
    <Card>
      <CardHeader>
        <CardTitle class="text-2xl">Tableau de bord admin</CardTitle>
        <CardDescription
          >Gérez les chats et les photos publiées depuis un seul
          endroit.</CardDescription
        >
      </CardHeader>
      <CardContent class="flex flex-wrap gap-2">
        ...
        <NuxtLink
          class="inline-flex h-9 items-center justify-center rounded-md bg-secondary px-4 py-2 text-sm font-medium text-secondary-foreground shadow-sm transition-colors hover:bg-secondary/80"
          to="/admin/photos"
        >
          Gérer les photos
        </NuxtLink>
